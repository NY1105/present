...
const Navbar = () => {
	...
	return (
		<nav className="sm:px-12 md:px-16 lg:px-20 py-4 fixed w-full justify-center sm:justify-start flex drop-shadow-md dark:bg-gray-800 bg-white dark:text-white text-black items-center">
			<div
			...
			<div className=" flex justify-middle sm:grow sm:justify-end ">
				{buttons.map((button) => (
					<div
						key={button.label}
						className="mx-1 px-3 py-2 text-sm sm:underline decoration-1 rounded-md dark:hover:bg-gray-700 hover:bg-gray-100 sm:text-base hover:cursor-pointer"
						onClick={() => {
