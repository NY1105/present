...
export default (props: Project) => {
	...
	return (
		<div
			className="flex py-1 sm:px-2 my-1 rounded-md border-2 border-gray-200 bg-gray-200 hover:border-gray-300 hover:bg-gray-300 dark:hover:border-gray-800 dark:hover:bg-gray-800 dark:border-gray-900 dark:bg-gray-900"
			onClick={() => {
